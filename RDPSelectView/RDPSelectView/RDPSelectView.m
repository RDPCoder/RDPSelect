...
#define RDP_SCREEN_BOUDS [UIScreen mainScreen].bounds
...
@interface RDPSelectView()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,copy) NSString *title;
@property (nonatomic,copy) NSString *cancelTitle;
@property (nonatomic,strong) NSArray *actionContents;
@property (nonatomic,copy) RDPSelectViewBlock selectBlock;
...
@implementation RDPSelectView

+ (void)rdp_showSelectViewWithTitle:(NSString *)title cancelButttonTitle:(NSString *)cancelButtonTitle actionContent:(NSArray<RDPSelectModel *> *)actionContent selectBlock:(RDPSelectViewBlock)selectBlock{
...
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle actonContent:(NSArray<RDPSelectModel *> *)actionContent selectBlock:(RDPSelectViewBlock)selectBlock{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RDPTableViewCell *cell = [RDPTableViewCell dequeueReusableWithTableView:tableView];
   
    RDPSelectModel *model = _actionContents[indexPath.row];
